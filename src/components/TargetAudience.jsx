...
export default function TargetAudience() {
    ...
    const audiences = t("targetAudience.items", { returnObjects: true });
        ...
        <section className="py-24 bg-slate-950 text-white relative overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-4 relative z-10">
                <div className="max-w-3xl mb-12">
                    <p className="text-sm font-bold uppercase tracking-[0.22em] text-brand-300 mb-4">
                        {t("targetAudience.label")}
                    </p>
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    {audiences.map((audience) => (
                        <article
                            key={audience.title}
                            className="rounded-3xl border border-white/10 bg-white/[0.06] p-7 backdrop-blur hover:-translate-y-1 hover:bg-white/[0.09] transition-all"
                        >
